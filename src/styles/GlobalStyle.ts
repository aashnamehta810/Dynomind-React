...
export default createGlobalStyle`
  ...
  .ant-popover-rtl .popupCountryListRtl{
    display: flex;
    flex-direction: row-reverse;
    justify-content:flex-end;
    position: relative;
  }
  .ant-popover-rtl .popupCountryListRtl span:nth-child(2) > div{ 
    display: flex;
    flex-direction: row-reverse;
  }
  .ant-popover-rtl .popupCountryListRtl span:nth-child(2) > div > div:nth-child(1){
    padding-right:14px
  }
  .ant-popover-rtl .popupCountryListRtl span:nth-child(2) > div > div:nth-child(2){
    position:absolute;
    right:0;
  }
